...
export const WarningIcon = () => {
  return (
    <svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M10.9712 0C11.4653 3.67407e-05 11.9511 0.127291 12.3816 0.36967C12.7582 0.581709 13.0812 0.875776 13.3278 1.2288L13.4288 1.38416L21.5494 14.9393L21.5569 14.9524C21.8079 15.3872 21.9411 15.8804 21.9425 16.3824C21.9438 16.8844 21.8129 17.3783 21.5644 17.8143C21.3158 18.2503 20.9571 18.6136 20.5246 18.8681C20.092 19.1226 19.6002 19.2594 19.0984 19.2649H2.84319C2.34129 19.2594 1.84952 19.1227 1.41692 18.8681C0.984358 18.6136 0.625748 18.2503 0.377167 17.8143C0.128614 17.3783 -0.00135072 16.8844 1.05851e-05 16.3824C0.00141622 15.8804 0.134557 15.3872 0.38559 14.9524C0.388105 14.9481 0.390493 14.9436 0.393077 14.9393L8.51271 1.38416C8.76897 0.961683 9.13031 0.612083 9.56088 0.36967C9.99138 0.12736 10.4772 0 10.9712 0ZM10.9712 1.91667C10.8065 1.91667 10.644 1.9594 10.5005 2.0402C10.3572 2.121 10.2368 2.23736 10.1514 2.37805L2.04489 15.9108C1.96129 16.0556 1.91722 16.2199 1.91668 16.3871C1.91621 16.5543 1.95938 16.7192 2.04208 16.8644C2.12495 17.0098 2.24507 17.1314 2.38929 17.2163C2.53345 17.3011 2.6975 17.3464 2.86472 17.3483H19.0778C19.245 17.3464 19.409 17.3011 19.5532 17.2163C19.6974 17.1315 19.8166 17.0098 19.8995 16.8644C19.9822 16.7191 20.0263 16.5544 20.0258 16.3871C20.0253 16.2199 19.9803 16.0556 19.8967 15.9108L11.7901 2.37805L11.7199 2.27698C11.6434 2.18108 11.5486 2.10078 11.4411 2.0402C11.2976 1.95943 11.1359 1.9167 10.9712 1.91667ZM10.9806 13.5149C11.5098 13.5149 11.9388 13.9441 11.9389 14.4733C11.9389 15.0025 11.5099 15.4316 10.9806 15.4316H10.9712C10.442 15.4316 10.0129 15.0025 10.0129 14.4733C10.013 13.9441 10.442 13.5149 10.9712 13.5149H10.9806ZM10.0129 10.6399V6.8066C10.013 6.27742 10.442 5.84827 10.9712 5.84827C11.5004 5.84838 11.9295 6.27749 11.9296 6.8066V10.6399C11.9296 11.1691 11.5004 11.5982 10.9712 11.5983C10.442 11.5983 10.0129 11.1692 10.0129 10.6399Z"
        fill="#FF9B61"
      />
    </svg>
  );
