...
export const TenthSection = () => {
  return (
    <Section className="relative w-full flex flex-col gap-y-7 items-center justify-center overflow-hidden px-5 md:px-0 bg-bg-default">
      ...
      <div className="relative z-20 flex flex-col gap-y-4 items-center text-center animate-fade-in">
      ...
      <div className="relative z-20 flex flex-col gap-y-6 text-center items-center">
        <p className="text-sm font-medium md:text-base lg:text-xl text-text-secondary">
          얼리버드 신청하고, <br /> 앱 출시 소식을 빠르게 받아보세요.
        </p>
        <Button size="lg" text="얼리버드 신청하기" variant="primary" onClick={() => {}} />
      </div>
    </Section>
  );
};
