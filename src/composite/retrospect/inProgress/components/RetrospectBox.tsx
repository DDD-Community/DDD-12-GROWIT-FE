      ...
      <div className="flex flex-col flex-1 gap-4 pt-1">
        ...
        {!isLocked && isCompleted ? (
          ...
          <div className="flex flex-col gap-4 w-full">
            <TextArea placeholder="회고 내용을 작성해주세요." onClick={e => e.preventDefault()} />
            <FlexBox className="ml-auto w-[72px]">
              <Button size="sm" text="완료" variant="tertiary" onClick={onSubmit} />
            </FlexBox>
          </div>
        ) : (
          <FlexBox className="bg-gray-800 py-3 px-4 w-full rounded-lg gap-4">
            ...
            <p className="label-1-normal text-label-normal">{week}주차 도달 시, 작성할 수 있습니다</p>
          </FlexBox>
        )}
      </div>
    </div>
