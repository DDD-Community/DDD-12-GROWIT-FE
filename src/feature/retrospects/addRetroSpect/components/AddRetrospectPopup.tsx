...
interface AddRetrospectPopupProps {
  userName: string;
  isOpen: boolean;
  onClose: () => void;
}

export const AddRetroSpectPopup = ({ userName, isOpen, onClose }: AddRetrospectPopupProps) => {
          ...
          <div className="relative w-full h-full">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-10">
              ...
              >
                ...
                <p className="title-2-bold text-primary-normal">오랜만이라 더 특별해요</p>
              </motion.div>
